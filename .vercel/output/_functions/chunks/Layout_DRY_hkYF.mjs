import { c as createComponent, a as createAstro, m as maybeRenderHead, s as spreadAttributes, e as addAttribute, n as renderSlot, b as renderTemplate, r as renderComponent, d as renderScript, o as renderHead } from './astro/server_C6WF4vph.mjs';
import 'piccolore';
/* empty css                         */
import 'clsx';
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es" class="scroll-smooth"> <head><meta charset="UTF-8"><meta name="description"', '><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.avif"><meta name="generator"', "><title>", '</title><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image" content="/favicon.avif"><!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"', '><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image" content="/favicon.avif"><script type="application/ld+json">\n			{\n			  "@context": "https://schema.org",\n			  "@type": "LocalBusiness",\n			  "name": "Miel HurdeGatina",\n			  "description": "Miel pura de abeja cosechada artesanalmente en Las Hurdes y Sierra de Gata. 100% natural.",\n			  "address": {\n				"@type": "PostalAddress",\n				"streetAddress": "Torrecilla de los \xC1ngeles",\n				"addressLocality": "Torrecilla de los \xC1ngeles",\n				"addressRegion": "C\xE1ceres",\n				"postalCode": "10869",\n				"addressCountry": "ES"\n			  },\n			  "geo": {\n					"@type": "GeoCoordinates",\n					"latitude": 40.2478918,\n					"longitude": -6.4163881\n				  },\n			  "url": "https://mielhurdegatina.com",\n			  "telephone": "+34659393507",\n			  "priceRange": "\u20AC",\n			  "areaServed": ["Sierra de Gata", "Las Hurdes", "Extremadura"]\n			}\n		<\/script><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400&display=swap" rel="stylesheet">', "", "", '</head> <body class="min-h-screen flex flex-col"> ', " ", " ", " ", " </body></html>"])), addAttribute(description, "content"), addAttribute(Astro2.generator, "content"), title, addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), renderComponent($$result, "Analytics", $$Index$1, {}), renderComponent($$result, "SpeedInsights", $$Index, {}), renderHead(), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Cart", $$Cart, {}), renderComponent($$result, "WhatsAppButton", $$WhatsAppButton, {}), renderComponent($$result, "CookieBanner", $$CookieBanner, {}));
